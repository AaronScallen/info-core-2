...
-- INSTRUCTIONS:
-- 1. Option A: Run this SQL file directly in Neon console
...
--    - Click "Run"
--
-- 2. Option B: Use psql command line:
--    psql YOUR_DATABASE_URL < add-indexes.sql
--
-- 3. Option C: Use the run-indexes.ts script:
--    npm run add-indexes
